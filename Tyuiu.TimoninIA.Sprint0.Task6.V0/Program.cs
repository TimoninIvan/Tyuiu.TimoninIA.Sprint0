namespace Tyuiu.TimoninIA.Sprint0.Task6.V0.Lib
{
    public class DataService
    {
        ...
        //Пример циклической структуры ( цикл с продусловием) while
        ...
        //Пример циклической структуры (цикл с потусловием) do while 
